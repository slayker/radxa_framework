...
private:
    ...
    int RenderToWfd(Target_info *src,Target_info *dst);    //rk : for lcdc composer
    ...
    static EGLConfig selectEGLConfig(EGLDisplay disp, EGLint visualId, bool useLcdcComposer);
    ...
    static void computeVisibleRegions(
            ...
            Region& dirtyRegion, Region& opaqueRegion, bool useLcdcComposer);
    ...
    Vector< sp<LayerBase> >     mVideoLayers;
    /* ------------------------------------------------------------------------
     * Feature prototyping
     */
