...
public:
    ...
    public:
        ...
        virtual buffer_handle_t getHandle() const = 0;
        virtual uint32_t getFlags() const  = 0;
        virtual hwc_layer_1_t * gethwcLayer() const  = 0;
        virtual char* getLayerName()   = 0;
        ...
        virtual void setLayerupdate(int32_t update) = 0;    //rk : for lcdc composer
        virtual void setLayercount(int32_t count) = 0;    //rk : for lcdc composer
        virtual void setLayerchange(int32_t change) = 0;    //rk : for lcdc composer
    ...
    uint32_t getLayerNum (int32_t id);
    // Events handling ---------------------------------------------------------
