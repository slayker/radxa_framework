...
#define FORCE_SCALE_FULLSCREEN      0
...
#ifdef TARGET_RK30
   // void        RenderVPUBuffToLayerBuff(  hwc_layer_1_t * Layer) const;
    void RenderVPUBuffToLayerBuff(   struct private_handle_t* srcandle) const;
    ...
    void                    setProjection(int orientation, const Rect& viewport, const Rect& frame, bool shouldTransform);
...
private:
    ...
    static status_t orientationToTransfrom(int orientation,
            int w, int h, Transform* tr, bool shouldTransform, bool scaled);
    void updateGeometryTransform(bool shouldTransform);
