...
public:
    ...
    mutable bool        mShouldTransform;
            // regions below are in window-manager space
            Region      visibleRegion;
            Region      coveredRegion;
            Region      visibleNonTransparentRegion;
            int32_t     sequence;
            int32_t     mQueuedFramesOld;   //rk : for lcdc composer
...
virtual int getBufferState(uint32_t addr) {  return 0; }
    /**
...
protected:
    ...
    volatile    int32_t         mTransactionFlags;
                ...
                String8         mName;
    mutable     bool            mDebug;
    mutable     float           mCachedPosX;
    mutable     float           mCachedPosY;
