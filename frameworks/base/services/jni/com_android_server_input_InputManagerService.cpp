...
#include <cutils/properties.h>
/*$_rbox_$_modify_$_zhangwen_20121122: make permission for atoi()*/
...
/*$_rbox_$_modify_$_zhangwen_20121122: this function is just for infrare mouse,*/
...
jclass clazz,jfloat x,jfloat y,jint w,jint h,jint ptr) {
    NativeInputManager* im = reinterpret_cast<NativeInputManager*>(ptr);
    int mID;
	char *mgetID=new char[4];
	char *mkeyMouseState=new char[4];
	float mx, my;
	...
	//mPointerController->setPosition(mx,my);
