...
class BluetoothManagerService extends IBluetoothManager.Stub {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case MESSAGE_SAVE_NAME_AND_ADDRESS: {
                    ...
                    synchronized(mConnection) {
                        if (!BluetoothChipName.equals("broadcom.bplus") && !mEnable && mBluetooth != null) {
                            try {
                                mBluetooth.enable();
                            } catch (RemoteException e) {
                    ...
                    synchronized(mConnection) {
                        if (mBluetooth != null) {
                            ...
                            if (!BluetoothChipName.equals("broadcom.bplus") && !mEnable) {
                                try {
                                    mBluetooth.disable();
                                } catch (RemoteException e) {
                ...
                case MESSAGE_BLUETOOTH_SERVICE_CONNECTED:
                {
                    ...
                    synchronized(mConnection) {
                        ...
                        if (mConnection.isGetNameAddressOnly()) {
                            ...
                            Message getMsg = mHandler.obtainMessage(MESSAGE_GET_NAME_AND_ADDRESS);
                            mHandler.sendMessage(getMsg);
                            if (!BluetoothChipName.equals("broadcom.bplus") && !mEnable) return;
                        }
                        ...
                        //Do enable request
                        if (BluetoothChipName.equals("broadcom.bplus") && mConnection.isTurnOnRadio()){
                            try {
    ...
    private void bluetoothStateChangeHandler(int prevState, int newState) {
        if (prevState != newState) {
            if ((BluetoothChipName.equals("broadcom.bplus")) && (prevState == BluetoothAdapter.STATE_OFF) && (newState == BluetoothAdapter.STATE_RADIO_OFF)) {
