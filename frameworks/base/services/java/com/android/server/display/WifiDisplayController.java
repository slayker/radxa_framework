...
/* $_rbox_$_modify_$_huangyonglin for do not listen the p2p connecton changed*/
	private void handleWFDConnectionChanged(NetworkInfo networkInfo,WifiP2pDevice P2pDeviceInfo)
		{
			...
			if (mWfdEnabled && networkInfo.isConnected()) {
				...
				mWifiP2pManager.requestConnectionInfo(mWifiP2pChannel, new ConnectionInfoListener(){
						...
						{
							Slog.d(TAG,"####onConnectionInfoAvailable(),info = "+info);
				...
				Slog.d(TAG,"######mWifiWFDServicerOn ="+mWifiWFDServicerOn);
...
/* $_rbox_$_modify_$_huangyonglin do not listen the p2p connecting changed. */		
