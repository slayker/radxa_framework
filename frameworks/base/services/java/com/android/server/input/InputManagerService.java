...
public class InputManagerService extends IInputManager.Stub
	...
	/*$_rbox_$_modify_$_zhangwen_20121122:  to call dispatchMouse() in JNI*/
	//$_rbox_$_modify_$_begin
	private static native void nativedispatchMouse(float x,float y,int w,int h,int ptr);
 	//$_rbox_$_modify_$_end

	
	/*$_rbox_$_modify_$_zhangwen_20121122:  to call dispatchMousebyCd() in JNI*/
	//$_rbox_$_modify_$_begin
	...
	/*$_rbox_$_modify_$_zhangwen_20121122: this function just for call the function in JNI*/
	//$_rbox_$_modify_$_begin
