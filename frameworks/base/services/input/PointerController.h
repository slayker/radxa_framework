...
public:
    ...
    //$_rbox_$_modify_$_chenxiao_$ begin: add to support showing cursor spots
    virtual void setCursorSpots(const PointerCoords* spotCoords, const uint32_t* spotIdToIndex,
...
public:
    ...
    //$_rbox_$_modify_$_chenxiao_$ begin: add to support showing cursor spots
    virtual void setCursorSpots(const PointerCoords* spotCoords,
            const uint32_t* spotIdToIndex, const uint32_t count);
    //$_rbox_$_modify_$_chenxiao_$ end
