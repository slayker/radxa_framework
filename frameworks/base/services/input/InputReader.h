...
private:
    ...
    void sync(nsecs_t when);
    //$_rbox_$_modify_$ add by chenxiao to support mouse wheel zoom
    float mZoomLength;
    void sync_zoom(nsecs_t when);
    int32_t mDisplayWidth;
    int32_t mDisplayHeight;
    //$_rbox_$_modify_$ end
};
/*$_rbox_$_modify_$_zhangwen_20121122:  define the KeyMouseInputMapper*/ 
//$_rbox_$_modify_$_begin
