...
//$_rbox_$_modify_$_lijiehong: add by lijiehong for support Tv Media controller
    public static final int KEYCODE_TV_MEDIA_PLAY_PAUSE = 220;
    public static final int KEYCODE_TV_MEDIA_STOP = 221;
    public static final int KEYCODE_TV_MEDIA_NEXT = 222;
    public static final int KEYCODE_TV_MEDIA_PREVIOUS = 223;
    public static final int KEYCODE_TV_MEDIA_FAST_FORWARD = 224;
    public static final int KEYCODE_TV_MEDIA_REWIND = 225;
    public static final int KEYCODE_TV_MEDIA_MULT_FORWARD = 226;
    public static final int KEYCODE_TV_MEDIA_MULT_BACKWARD = 227;
    public static final int KEYCODE_TV_MEDIA_PLAY = 228;
    public static final int KEYCODE_TV_MEDIA_PAUSE = 229;
//$_rbox_$_modify_$ end

/*$_rbox_$_modify_$_zhangwen_20121122: just for infrare mouse*/
//$_rbox_$_modify_$_begin

	public static final int KEYCODE_TV_KEYMOUSE_LEFT = 230;
	public static final int KEYCODE_TV_KEYMOUSE_RIGHT = 231;
	public static final int KEYCODE_TV_KEYMOUSE_UP = 232;
	public static final int KEYCODE_TV_KEYMOUSE_DOWN = 233;
	public static final int KEYCODE_TV_KEYMOUSE_MODE_SWITCH = 234;
	
//$_rbox_$_modify_$_end

       //$_rbox_$_modify_$_chengmingchuan_20121212
       //$_rbox_$_modify_$_begin
	public static final int KEYCODE_TV_ROTATE_LEFT = 240;
	public static final int KEYCODE_TV_ROTATE_RIGHT = 241;
	public static final int KEYCODE_TV_ZOOM_IN = 242;
	public static final int KEYCODE_TV_ZOOM_OUT = 243;
       //$_rbox_$_modify_$_end
