...
//$_rbox_$_modify_$_lijiehong end
    /*$_rbox_$_modify_$_zhangwen_20121122: Make a interface in WindowManagerService.java for other apps  */
	//$_rbox_$_modify_$_begin
    void dispatchMouse(float x,float y,int w,int h);
    //$_rbox_$_modify_$_end
    
    /*$_rbox_$_modify_$_zhangwen_20121122: Make a interface in WindowManagerService.java for other apps by coordinate */
	//$_rbox_$_modify_$_begin
    ...
    /*$_rbox_$_modify_$_cx_20130305: Make a interface in WindowManagerService.java for gamecontrol */
	//$_rbox_$_modify_$_begin
 ...
 /*$_rbox_$_modify_$_hh_20130108*/   
    /**
    * get focus window's surface's height
    */
    int getFocusWindowSurfaceHeight();
 /*$_rbox_$_modify_$_end*/

 	 /* 
 	  * redraw Focus window
 	 */
 	 void invalidateFocusWindow();
}
