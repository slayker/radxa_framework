...
public class HTML5VideoView implements MediaPlayer.OnPreparedListener {
    ...
    public void start() {
        if (DebugFlags.WEB_HTML5)
			Log.d(LOGTAG, "start, mCurrentState: " + mCurrentState);
    ...
    public void pause() {
		if (DebugFlags.WEB_HTML5)
			Log.d(LOGTAG, "pause, mCurrentState: " + mCurrentState);
        if (isPlaying()) {
            mPlayer.pause();
    ...
    public void reset() {
		if (DebugFlags.WEB_HTML5)
			Log.d(LOGTAG, "reset, mCurrentState: " + mCurrentState);
    ...
    public void stopPlayback() {
		if (DebugFlags.WEB_HTML5)
			Log.d(LOGTAG, "stopPlayback, mCurrentState: " + mCurrentState);
        if (mCurrentState == STATE_PREPARED) {
            mPlayer.stop();
        }
    }
    ...
    public static void release() {
		if (DebugFlags.WEB_HTML5)
			Log.d(LOGTAG, "release, mCurrentState: " + mCurrentState);
