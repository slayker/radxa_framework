...
/*$_rbox_$_modify_$_zhangwen_20121122: */
...
public class Activity extends ContextThemeWrapper
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event)  {
	    ...
	    /*$_rbox_$_modify_$_zhangwen_20121122:Button state prompts of Infrared mouse*/
	   //$_rbox_$_modify_$_begin
		String mstate=null;
		mstate=SystemProperties.get("sys.KeyMouse.mKeyMouseState");
		if((keyCode==234)&&mstate.equals("on")){
		Toast.makeText(Activity.this, "Into Mouse mode,click this key again out of this mode", Toast.LENGTH_LONG).show();
		}
		if((keyCode==234)&&mstate.equals("off")){
		Toast.makeText(Activity.this, "Restore the default button mode", Toast.LENGTH_LONG).show();
		}
		//$_rbox_$_modify_$_end
