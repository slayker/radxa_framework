...
public class AudioService extends IAudioService.Stub implements OnFinished {
   ...
   /** @hide Maximum volume index values for audio streams */
    ...
    /*$_rbox_$_modify_$_zhangxueguang_$_begin_$_20121212_$*/
	//do not fix volume and volumepanel slider
    ...
    private int getDeviceForStream(int stream) {
	    ...
	    /*$_rbox_$_modify_$_zhangxueguang_$_begin_$_20130304_$*/
	    } else if((device & AudioSystem.DEVICE_OUT_AUX_DIGITAL) != 0) {
		device = AudioSystem.DEVICE_OUT_AUX_DIGITAL;	
	    /*$_rbox_$_modify_$_zhangxueguang_$_end_$_20130304_$*/			
            } else {
    ...
    private class AudioHandler extends Handler {
        ...
        private void playSoundEffect(int effectType, int volume) {
            if(!SystemProperties.getBoolean("media.cfg.audio.soundeffect", true))
                return;
            synchronized (mSoundEffectsLock) {
                if (mSoundPool == null) {
                    return;
    ...
    private boolean handleDeviceConnection(boolean connected, int device, String params) {
        synchronized (mConnectedDevices) {
            ...
            /*$_rbox_$_modify_$_zhangxueguang_$_end_$_20121212_$*/
    ...
    int mBecomingNoisyIntentDevices =
            ...
            AudioSystem.DEVICE_OUT_ALL_USB|AudioSystem.DEVICE_IN_ALL_USB;
	/*$_rbox_$_modify_$_zhangxueguang_$_end_$_20121212_$*/
    ...
    private void onSetWiredDeviceConnectionState(int device, int state, String name)
    {
        synchronized (mConnectedDevices) {
			...
			/*$_rbox_$_modify_$_zhangxueguang_$_begin_$_20121212_$*/
            boolean isUsb = ((device & (AudioSystem.DEVICE_OUT_ALL_USB|AudioSystem.DEVICE_IN_ALL_USB)) != 0);
			/*$_rbox_$_modify_$_zhangxueguang_$_end_$_20121212_$*/
