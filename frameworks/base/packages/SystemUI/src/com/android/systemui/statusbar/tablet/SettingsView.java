...
//$_rbox_$_modify_$_chenzhi: remove rotate icon && brightness icon
    ...
    public void onClick(View v) {
        switch (v.getId()) {
		    ...
		    //$_rbox_$_modify_$_chenxiao_$_begin
                 Intent i_net = new Intent("com.android.disablewallpaper");
                 getContext().sendBroadcast(i_net);
	          //$_rbox_$_modify_$_chenxiao_$_end
                onClickNetwork();
                break;
            case R.id.settings:
		    //$_rbox_$_modify_$_chenxiao_$_begin
                 Intent i_set = new Intent("com.android.disablewallpaper");
                 getContext().sendBroadcast(i_set);
	          //$_rbox_$_modify_$_chenxiao_$_end
                onClickSettings();
                break;
        }
